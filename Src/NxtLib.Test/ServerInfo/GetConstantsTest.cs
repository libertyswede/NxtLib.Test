        ...
        private void CheckRequestTypes()
        {
            using (Logger = new TestsessionLogger())
            {
                var expectedRequestTypes = new List<string>
                {
                    ...
                    "currencyReserveIncrease", "currencySell", "decodeFileToken", "decodeHallmark", "decodeQRCode-notexist",
                    ...
                    "eventRegister", "eventWait", "extendTaggedData", "fullHashToId-notexist", "fullReset", "generateFileToken",
                    ...
                    "getTaggedData", "getTaggedDataExtendTransactions-notexisting", "getTime", "getTrades", "getTransaction",
