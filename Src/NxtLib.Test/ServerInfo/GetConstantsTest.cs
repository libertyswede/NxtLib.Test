        ...
        private void CheckRequestTypes()
        {
            using (Logger = new TestsessionLogger())
            {
                var expectedRequestTypes = new List<string>
                {
                    ...
                    "getAccountCurrentBidOrders", "getAccountExchangeRequests", "getAccountId", "getAccountLedger",
                    "getAccountLedgerEntry", "getAccountLessors", "getAccountPhasedTransactionCount",
