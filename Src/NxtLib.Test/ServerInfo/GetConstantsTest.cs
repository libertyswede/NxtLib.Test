        ...
        private void CheckRequestTypes()
        {
            using (Logger = new TestsessionLogger())
            {
                var expectedRequestTypes = new List<string>
                {
                    ...
                    "currencyReserveIncrease", "currencySell", "decodeFileToken", "decodeHallmark", "decodeQRCode",
                    "decodeToken", "decryptFrom", "deleteAlias", "deleteAssetShares", "deleteCurrency", "dgsDelisting",
                    "dgsDelivery", "dgsFeedback", "dgsListing", "dgsPriceChange", "dgsPurchase", "dgsQuantityChange",
                    "dgsRefund", "dividendPayment", "downloadTaggedData", "dumpPeers", "encodeQRCode", "encryptTo",
                    "eventRegister", "eventWait", "extendTaggedData", "fullHashToId", "fullReset", "generateFileToken",
                    ...
                    "getExpectedCurrencyTransfers-notexisting", "getExpectedExchangeRequests-notexisting", "getExpectedOrderCancellations",
                    ...
                    "getVoterPhasedTransactions", "hash-notexisting", "hexConvert", "issueAsset", "issueCurrency", "leaseBalance",
                    ...
                    "requeueUnconfirmedTransactions", "retrievePrunedData-notexisting", "rsConvert", "scan", "searchAccounts",
